    ...
    const handleEditEvent = async (e) => {
        ...
        try {
            ...
            const updatedEvent = {
                ...
                registUntil: new Date(`${eventData.registUntilDate}T${eventData.registUntilTime}`),
            ...
            <div className="max-w-7xl mx-auto py-12 px-6 pt-24">
                ...
                <form onSubmit={handleEditEvent} className="bg-[#F0F0F0] p-6 rounded-lg grid grid-cols-1 md:grid-cols-2 gap-6 shadow-2xl">
                    <div>
                        ...
                        <div className="flex gap-2 mb-4">
                            <input
                                ...
                                className="w-1/2 p-2 border border-ijoTua rounded"
                                required
                            />
                            <input
                                type="time"
                        ...
                        <div className="flex gap-2 mb-4">
                            <input
                                type="date"
                                value={eventData.registUntilDate}
                                onChange={(e) => setEventData({ ...eventData, registUntilDate: e.target.value })}
                                className="w-1/2 border-ijoTua p-2 border rounded"
                                required
                            />
                            <input
                                type="time"
                                value={eventData.registUntilTime}
                                onChange={(e) => setEventData({ ...eventData, registUntilTime: e.target.value })}
                                className="w-1/2 border-ijoTua p-2 border rounded"
                                required
                            />
                        </div>
                        ...
                        <input
                            type="text"
                            value={eventData.locate}
                            onChange={(e) => setEventData({ ...eventData, locate: e.target.value })}
                    ...
                    <div>
                        ...
                        <textarea
                            value={eventData.detailActivity}
                            onChange={(e) => setEventData({ ...eventData, detailActivity: e.target.value })}
                            className="w-full border-ijoTua p-2 border rounded mb-4"
                            required
                        />
                        ...
                        <textarea
                            value={eventData.relawanKriteria}
                            onChange={(e) => setEventData({ ...eventData, relawanKriteria: e.target.value })}
                            className="w-full border-ijoTua p-2 border rounded mb-4"
                            required
                        />
                        ...
                        <div className="flex gap-2 mb-4">
                            <input
                                type="text"
                                value={currentPerlengkapan}
                                onChange={(e) => setCurrentPerlengkapan(e.target.value)}
                                placeholder="Tambahkan perlengkapan"
                                className="w-full border-ijoTua p-2 border rounded"
                            />
                            <button
                                type="button"
                                onClick={addPerlengkapanItem}
                                className="bg-ijoTua text-white px-4 rounded hover:bg-green-600"
                            >
                                Tambah
                            </button>
                        </div>
                        ...
                        <input
                            ...
                            value={eventData.detailJob?.jobName}
                            onChange={(e) =>
                                setEventData({ ...eventData, detailJob: { ...eventData.detailJob, jobName: e.target.value } })
                            }
                            className="w-full p-2 border rounded mb-2 border-ijoTua"
                            required
                        />
                        <input
                            type="text"
                            placeholder="Deskripsi Pekerjaan"
                            value={eventData.detailJob?.jobDesc}
                            onChange={(e) =>
