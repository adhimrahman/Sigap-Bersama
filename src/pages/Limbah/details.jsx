        ...
        {isLoading ? ( <Spinner /> ) : (
            ...
            <section className="max-w-6xl mx-auto py-12 pt-24 px-6">
                <div className="flex gap-6 p-5">
                    ...
                    <button className={`w-full mt-2 px-6 py-2 ${ user?.role === "komunitas" ? "bg-gray-400 cursor-not-allowed" : "bg-red-500 hover:bg-red-600"
                    ...
                    onClick={() => {
                        ...
                        } else { navigate(`/donate/limbah/${id}`); }
                    ...
                    {limbah.isCreator && (
                        <button className="w-full mt-2 px-6 py-2 bg-ijoTua text-white font-bold rounded-lg flex items-center justify-center gap-2 hover:bg-green-800" onClick={() => navigate(`/editEvent/limbah/${id}`)}>
